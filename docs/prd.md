...
The `Overview` sheet should lead with the loaded period, account and transaction counts, observed income, net spending, net cash flow, savings/investing activity, and review counts. It must state that totals reflect only loaded accounts and files.
